...
def permute_proba_mat(
	reference = 1,
    	folderin = "../Data/output/raw/prob-gp-gp/", 
	folderout = "../Data/output/processed/reordered/proba-gp-gp/", 
	rows = 10, 
	columns = 10, 
	nsamples = 500):
    
    # read in the best permutations from alignments
    results = np.load('../Data/output/processed/alignments/1proba10gp-10gp.npy')
...
def permute_user_gp(
    reference = 41,
	folderin = "../Data/output/raw/user-gp/", 
	folderout = "../Data/output/processed/reordered/user-gp/", 
	rows = 100, 
	columns = 10, 
	nsamples = 500):
...
def permute_place_gp(
	...
	folderout = "../Data/output/processed/reordered/place-gp/", 
	rows = 100, 
	columns = 10, 
	nsamples = 500):
